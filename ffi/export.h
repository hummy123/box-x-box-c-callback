#ifndef __BOOK_AND_BOX_ML_H__
#define __BOOK_AND_BOX_ML_H__
...
#if !defined(PART_OF_BOOK_AND_BOX) && \
    !defined(STATIC_LINK_BOOK_AND_BOX) && \
    !defined(DYNAMIC_LINK_BOOK_AND_BOX)
#define PART_OF_BOOK_AND_BOX
#endif

#if defined(PART_OF_BOOK_AND_BOX)
#define MLLIB_PRIVATE(x) PRIVATE x
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(STATIC_LINK_BOOK_AND_BOX)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(DYNAMIC_LINK_BOOK_AND_BOX)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) EXTERNAL x
#else
#error Must specify linkage for book_and_box
#define MLLIB_PRIVATE(x)
